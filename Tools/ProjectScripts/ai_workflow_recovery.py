...
class AIWorkflowRecovery:
    ...
    def _get_repo_owner(self) -> str:
        ...
        owner, _ = git_operations.get_repo_info(self.repo_path)
        return owner
    ...
    def apply_ai_fix(self, failure: WorkflowFailure) -> bool:
        """Apply AI-generated fix for the failure using fix_handlers module"""
        logger.info(f"🔧 Applying AI fix for: {failure.error_type}")
        return fix_handlers.apply_fix(self.repo_path, failure)
    ...
    def commit_and_push_fixes(self, failure: WorkflowFailure) -> bool:
        """Commit and push the applied fixes using git_operations module"""
        return git_operations.commit_and_push_fixes(self.repo_path, failure)
