...
public struct MomentumFinanceApp: App {
    ...
    public init() {
        ...
        // Initialize service locator (will be set up with model context later)
        print("MomentumFinanceApp: Service locator ready for initialization")
    }
            ...
            if let container = sharedModelContainer {
                ContentView()
                    ...
                    .onAppear {
                        ...
                        ServiceLocator.shared.setup(with: container.mainContext)
                        print("MomentumFinanceApp: Services initialized")
                    }
            } else {
