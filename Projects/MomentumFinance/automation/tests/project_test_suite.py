...
class ProjectTestSuite:
    ...
    def test_project_structure(self):
        ...
        try:
            ...
            print(
                f"  ✅ Found {len(swift_files)} Swift files ({len(source_files)} source, {len(test_files)} test)"
            )
    ...
    def test_git_repository(self):
        ...
        try:
            ...
            commit_count = (
                commit_result.stdout.strip() if commit_result.returncode == 0 else "0"
            )
    ...
    def test_xcode_build(self):
        ...
        try:
            ...
            self.results["tests"]["xcode_build"] = {"status": "error", "error": str(e)}
            print(f"  ❌ Error: {e}")
            return False
    ...
    def test_code_quality(self):
        ...
        try:
            ...
            for file in source_files:
                try:
                    with open(file, "r", encoding="utf-8") as f:
                        ...
                        todo_count += len(
                            re.findall(r"TODO|todo", content, re.IGNORECASE)
                        )
                        fixme_count += len(
                            re.findall(r"FIXME|fixme", content, re.IGNORECASE)
                        )
            ...
            self.results["tests"]["code_quality"] = {"status": "error", "error": str(e)}
            print(f"  ❌ Error: {e}")
            return False
    ...
    def test_automation_system(self):
        ...
        try:
            ...
            print(
                f"  ✅ Components found: {sum(found_components.values())}/{len(found_components)}"
            )
