...
# Files to add
files_to_add = [
  'Components/Journal/JournalEmptyStateView.swift',
  'Components/Journal/JournalHeaderView.swift',
  'Components/Journal/JournalListView.swift',
  'Components/Journal/JournalRow.swift'
]
