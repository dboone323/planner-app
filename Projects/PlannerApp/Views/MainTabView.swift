...
public struct MainTabView: View {
    ...
    public var body: some View {
        ...
        TabView(selection: self.$selectedTabTag) {
            ...
            // --- AI Tab ---
            AIView()
                .tabItem { Label(TabTags.ai, systemImage: "brain.head.profile") }
                .tag(TabTags.ai)

            // Pending: Add haptic feedback for tab switches on iOS devices
            // Pending: Implement tab reordering functionality for user customization
            // Pending: Add keyboard shortcuts for tab navigation on macOS
