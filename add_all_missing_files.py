...
def add_files_to_project(missing_files):
    ...
    build_section_end = build_file_section.group(1).rfind(
    ...
    file_section_end = file_ref_section.group(1).rfind(
...
def main():
    ...
    for file_path in files_on_disk:
        ...
        if file_path not in files_in_project and filename not in [
